...
import {ActivityContent, Image,Title,Paragraph} from '../styled-components/utilities'
       ...
       <React.Fragment key={ind} >
        <Col xl={6} lg={{ span: 6, offset: 0 }} md={11} sm={24} >
          ...
          <Row justify='center'>
            ...
            <Button type='primary' shape="round">เข้าร่วม</Button>
          </Row>
        </Col>
        <Col xl={{ span: 6, offset: 2}} lg={{ span: 6, offset: 2 }}  md={11} sm={24} >
          <Image src='https://via.placeholder.com/300x290' alt='' />
          <Row justify='center'>
            <Title>รีไซเคิลขวด</Title>
            <Paragraph>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit, Lorem ipsum dolor sit amet.
              alias!
            </Paragraph>
            <Button type='primary' shape="round">เข้าร่วม</Button>
          </Row>
        </Col>
        <Col xl={{ span: 6, offset: 2 }} lg={{ span: 6, offset: 2 }} md={0} sm={0}  >
          <Image src='https://via.placeholder.com/300x290' alt='' />
          <Row justify='center'>
